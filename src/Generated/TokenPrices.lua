...
PeaversCurrencyData.TokenPrices = {
  ...
  regions = {
    US = {
      goldPrice = 262733,  -- Gold cost of a token
      realPrice = 20,      -- USD cost of a token
      currency = "USD",
      goldValue = 0.0000761229, -- USD value of 1 gold
    },
    EU = {
      goldPrice = 346072,  -- Gold cost of a token
      realPrice = 20,      -- EUR cost of a token
      currency = "EUR",
      goldValue = 0.0000577914, -- EUR value of 1 gold
    },
    KR = {
    ...
    TW = {
      goldPrice = 603308,  -- Gold cost of a token
      realPrice = 500,      -- TWD cost of a token
      currency = "TWD",
      goldValue = 0.0008287641, -- TWD value of 1 gold
    },
  }
}
